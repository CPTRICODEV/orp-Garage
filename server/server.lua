RegisterNetEvent('orp_garage:ThrowError', function(text)
    error(text)
end)
...
lib.callback.register('orp_garage:GetVehicles', function(source, garageType, job)
...
lib.callback.register('orp_garage:GetImpound', function(source, type)
    local xPlayer = ESX.GetPlayerFromId(source)
    local identifier = xPlayer.getIdentifier()
    local vehicles = {}
...
lib.callback.register('orp_garage:CheckOwnership', function(source, plate, model, currentGarage)
    local xPlayer = ESX.GetPlayerFromId(source)
    local identifier = xPlayer.getIdentifier()
...
RegisterNetEvent('orp_garage:ChangeStored', function(plate)
...
RegisterNetEvent('orp_garage:SaveVehicle', function(vehicle, plate, ent, garage)
...
RegisterNetEvent('orp_garage:SpawnVehicle', function(model, plate, coords, heading, price)
